...
#import "XQCommonTools+SystemInfo.h"
#import <UIKit/UIKit.h>
#import <AdSupport/AdSupport.h>
#import "SimulateIDFA.h"
#import "sys/utsname.h"

@implementation XQCommonTools (SystemInfo)
#pragma mark -
#pragma mark - 系统信息类
///软件版本
//the AppVersion
...
- (BOOL)isEnglishLanguage {
    return [self getLanguage] == kXQLanguageEn;
}
...
- (XQSystemLanguage)getLanguage {
    ...
    if ([language isEqualToString:@"en"]) {
        return kXQLanguageEn;   //英文
    } else if ([language isEqualToString:@"zh-Hant"]) {
        return kXQLanguageTC;   //繁体中文
    } else if ([language isEqualToString:@"zh-Hans"]) {
        return kXQLanguageCN;   //简体中文
    } else {
        return kXQLanguageOther;    //其他语言
    }
}
