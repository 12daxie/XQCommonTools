...
#import "XQCommonTools+Multimedia.h"
...
@implementation XQCommonTools (Multimedia)
#pragma mark -
#pragma mark - 图像视频处理类
...
- (void)playMusicWithMusicFilePath:(NSString *)musicPath withRepeat:(BOOL)repeat {
    NSURL *musicUrl = [[XQCommonTools sharedXQCommonTools] urlCreatedByString:musicPath];
